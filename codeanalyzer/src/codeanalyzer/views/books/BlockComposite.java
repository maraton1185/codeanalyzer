...
import codeanalyzer.books.section.BookSectionImage;
...
import codeanalyzer.views.books.interfaces.IBlockOptions;

public class BlockComposite implements IBlockComposite {
	...
	public void renderGroups(BookSection section) {
		...
		IBlockOptions defaultTune = new IBlockOptions() {
			@Override
		...
		IBlockOptions bookmarkTune = new IBlockOptions() {
	...
	private void addImageSections(Composite comp) {
		...
		for (final BookSectionImage sectionImage : imageList) {
			...
			IBlockOptions pictureTune = new IBlockOptions() {
				@Override
