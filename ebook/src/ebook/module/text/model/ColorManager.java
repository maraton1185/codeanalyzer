...
public class ColorManager implements IColorManager {
	 ...
	 * 
	 * @see
	 * ru.codeanalyzer.editor.core.IColorManager#getColor(org.eclipse.swt.graphics
	 * .RGB)
	 */
	@Override
	...
	public RGB toRGB(String text) {
		...
		String[] t = text.split(",");
		return new RGB(Integer.parseInt(t[0].trim()), Integer.parseInt(t[1]
				.trim()), Integer.parseInt(t[2].trim()));
	}
	...
	public RGB getStandartProcedureColor(String proc_name) {
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR1));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR2));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR3));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR4));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR5));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR6));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR7));
		// }
		//
		...
		// return color
		// .toRGB(store
		// .getString(PreferenceConstants.STANDART_PROCEDURE_COLOR8));
		// }
	...
	public IToken getToken(TOKENS type) {
		...
		case COMPARE_ADDED:
			return new Token(new TextAttribute(
					getColor(IColorManager.COMPARE_ADDED)));
		case COMPARE_CHANGED:
			return new Token(new TextAttribute(
					getColor(IColorManager.COMPARE_CHANGED)));
