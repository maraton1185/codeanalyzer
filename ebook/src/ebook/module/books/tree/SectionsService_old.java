...
public class SectionsService_old {
	...
	//
	// SQL =
	// "Select Top 1 T.SORT FROM SECTIONS AS T WHERE T.PARENT=? ORDER BY T.SORT DESC";
	...
	//
	// SQL =
	// "INSERT INTO SECTIONS (TITLE, PARENT, BLOCK, SORT) VALUES (?,?,?,?);";
	...
	// Connection con = book.getConnection();
	// String SQL =
	// "Select T.TITLE, T.ID, T.PARENT, T.BLOCK, T.OPTIONS FROM SECTIONS AS T WHERE T.PARENT IS NULL ORDER BY T.SORT, T.ID";
	...
	// Connection con = book.getConnection();
	// String SQL =
	// "Select T.TITLE, T.ID, T.PARENT, T.BLOCK, T.OPTIONS FROM SECTIONS AS T WHERE T.PARENT=? ORDER BY T.SORT, T.ID";
	//
	// PreparedStatement prep = con.prepareStatement(SQL);
	...
	// Connection con = book.getConnection();
	// String SQL =
	// "Select T1.TITLE, T1.ID, T1.PARENT, T1.BLOCK, T1.OPTIONS FROM SECTIONS AS T "
	...
	// Connection con = book.getConnection();
	// String SQL =
	// "Select TOP 1 T.TITLE, T.ID, T.PARENT, T.BLOCK, T.OPTIONS FROM SECTIONS AS T WHERE T.PARENT=? ORDER BY T.SORT DESC, T.ID DESC";
	...
	// Connection con = book.getConnection();
	// String SQL =
	// "Select T.DATA, T.TITLE, T.SORT, T.EXPANDED, T.ID FROM S_IMAGES AS T WHERE T.SECTION=? ORDER BY T.SORT, T.ID";
	//
	// PreparedStatement prep = con.prepareStatement(SQL);
	// prep.setInt(1, section.id);
	// ResultSet rs = prep.executeQuery();
	...
	//
	// SQL =
	// "Select Top 1 T.SORT FROM S_IMAGES AS T WHERE T.SECTION=? ORDER BY T.SORT DESC";
	// prep = con.prepareStatement(SQL);
	//
	// prep.setInt(1, section.id);
	// ResultSet rs = prep.executeQuery();
	...
	//
	// SQL =
	// "INSERT INTO S_IMAGES (TITLE, DATA, SORT, EXPANDED, SECTION) VALUES (?,?,?,?,?);";
