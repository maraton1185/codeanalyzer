package ebook.module.books.views.section.tools;
...
import ebook.module.books.tree.SectionImage;
import ebook.module.books.tree.SectionInfo;
import ebook.module.books.tree.SectionInfoOptions;
import ebook.module.books.views.section.interfaces.IBlockTune;
import ebook.module.books.views.section.interfaces.ISectionComposite;
...
public class SectionComposite implements ISectionComposite {
	...
	public void initSectionView(FormToolkit toolkit, ScrolledForm form,
			BookConnection book, SectionInfo section) {
	...
	public void initBlockView(FormToolkit toolkit, ScrolledForm form,
			BookConnection book, SectionInfo section, MDirtyable dirty) {
