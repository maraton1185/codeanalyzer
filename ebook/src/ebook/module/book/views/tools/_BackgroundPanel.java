 ...
 */
public class _BackgroundPanel extends JPanel {
	 ...
	 */
	public _BackgroundPanel(Image image) {
		this(image, SCALED);
	}
	 ...
	 */
	public _BackgroundPanel(Image image, int style) {
		setImage(image);
		setStyle(style);
	 ...
	 */
	public _BackgroundPanel(Image image, int style, float alignmentX,
			float alignmentY) {
		setImage(image);
		setStyle(style);
	 ...
	 */
	public _BackgroundPanel(Paint painter) {
		setPaint(painter);
		setLayout(new BorderLayout());
	}
