...
public class _DbService {
	...
	//
	// // private BuildInfo getProc(Connection con, int index) throws
	// SQLException
	// // {
	// //
	...
	// // rs.close();
	// // SQL =
	// "Select ID from PROCS WHERE (NAME = ? AND MODULE != ? AND EXPORT)";
	// // prep = con.prepareStatement(SQL);
	// // prep.setString(1, func_name);
	// // prep.setInt(2, context.module);
	// // rs = prep.executeQuery();
	...
	// }
	//
	// private int findModule(Connection con, _BuildInfo data) throws
	// SQLException {
	//
	// String SQL;
	// PreparedStatement prep;
	...
	//
	// SQL =
	// "SELECT T.OBJECT, T1.TITLE1, T1.TITLE2, T.MODULE, T2.NAME, T2.TITLE, T.ID, T.TITLE, T.NAME, T.EXPORT, T0.TEXT FROM "
	// + "PROCS_TEXT AS T0 "
	...
	//
	// String SQL =
	// "SELECT T.ID, T.TITLE1, T.TITLE2, T2.ID, T2.NAME, T2.TITLE FROM "
	// + "OBJECTS AS T "
	...
	// *************************************************************
	//
	// public void getCalls(List<_BuildInfo> list, Connection con, _BuildInfo
	// data,
	...
	// // COMPARE *************************************************************
	//
	// public void compareModules(CompareResults compareResults, Connection
	// con1,
	...
	// }
	//
	// public void compareObjects(CompareResults compareResults, Connection
	// con1,
